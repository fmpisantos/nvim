-- =============================================================================
-- Filetype plugin for cursor_agent prompt buffers
-- =============================================================================
-- Provides an @ trigger for fuzzy file references and #buffer/#buf expansion.

if vim.b.did_ftplugin_cursoragent then
    return
end
vim.b.did_ftplugin_cursoragent = true
...
local function try_replace_buffer_shortcut()
    local source_file = vim.b.cursor_agent_source_file
